                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SMK Bina Karya 2 Karawang</h2>
                                    <!-- <h5 class="text-white op-7 mb-2">Absen Lebih mudah gunakan Aplikasi Absensi</h5> -->
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="#" class="btn btn-white btn-border btn-round mr-2">jln. Pangkal Perjuangan (By Pass) - Tanjungpura Karawang 
	<br>Email : binakarya2_krw@gmail.com Telp.0838 7318 1616</a>
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy; <?php echo date('Y');?> Absensi Siswa.<a href="index.php">SMK BK 2 KARAWANG </a> 
                    </div>
                </div>
            </footer>
