...
<head>
    ...
    <link rel="icon" href="assets/img/logoBK2.ico" type="image/x-icon" />
        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/logoBK2.jpg" alt="navbar brand" class="navbar-brand" width="40">
    ...
    <footer class="footer">
        <div class="container">
            <div class="copyright ml-auto">
                &copy; <?php echo date('Y');?> SMK Bina Karya 2 Karawang 
                | 2024)
            </div>
        </div>
    </footer>
