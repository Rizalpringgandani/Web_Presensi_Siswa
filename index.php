...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="icon" type="image/png" href="assets/img/logoBK2.ico" />
    <!--===============================================================================================-->
            ...
            <div class="wrap-login100">
                <form method="post" action="" class="login100-form validate-form">
                    <span class="login100-form-title p-b-48">
                        ...
                        <img src="./assets/img/logoBK2.jpg" width="100">
                    </span>
				...
				if ($_SERVER['REQUEST_METHOD']=='POST') {
					...
					if ($level==1) {
						// Guru
						$sqlCek = mysqli_query($con,"SELECT * FROM tb_guru WHERE nik='$_POST[username]' AND password='$pass' AND status='Y'");
